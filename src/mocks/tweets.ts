...
export const mockTweets: TweetRecord[] = [
  ...
  },
  {
    id: "t9",
    authorId: "u1",
    text: "Wrote my first Server Action today. Deleting an API route never felt this good.",
    media: [],
    createdAt: "2026-09-19T21:10:00.000Z",
    replyToId: null,
    stats: { replies: 2, retweets: 4, likes: 38 },
    likedByViewer: false,
    retweetedByViewer: false,
    bookmarkedByViewer: false,
  },
  {
    id: "t10",
    authorId: "u1",
    text: "Hot take: most loading spinners are a data-fetching problem wearing a UI costume.",
    media: [],
    createdAt: "2026-09-19T14:32:00.000Z",
    replyToId: null,
    stats: { replies: 6, retweets: 11, likes: 92 },
    likedByViewer: false,
    retweetedByViewer: false,
    bookmarkedByViewer: false,
  },
  {
    id: "t11",
    authorId: "u1",
    text: "Measured every spacing value on a real screen instead of guessing. The layout finally stopped drifting.",
    media: [],
    createdAt: "2026-09-18T18:05:00.000Z",
    replyToId: null,
    stats: { replies: 1, retweets: 3, likes: 27 },
    likedByViewer: false,
    retweetedByViewer: false,
    bookmarkedByViewer: false,
  },
  {
    id: "t12",
    authorId: "u1",
    text: "Reading the framework docs before writing code saves more time than any shortcut I know.",
    media: [],
    createdAt: "2026-09-17T10:48:00.000Z",
    replyToId: null,
    stats: { replies: 0, retweets: 2, likes: 19 },
    likedByViewer: false,
    retweetedByViewer: false,
    bookmarkedByViewer: false,
  },
